...
class Tecnico
{
    ...
    public function listar($idUsuario)
    {
        ...
        $sql ="SELECT a.nombre,a.fechaAsignacion,a.fechaAceptacion,a.fechaEvaluacion,d.nombre As ditamenNombre
                FROM  evaluacionconacyt AS a ,cvu AS b, cvuconacyt AS c ,dictamenconacyt As d
                 WHERE a.idEvaluacionConacyt = c.idEvaluacionConacyt ,a.idDictamenConacyt=d.idDictamenConacyt
