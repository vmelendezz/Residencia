...
<div class="modal fade" id="modal_detalles" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="LabelModal"><strong> Generar reporte</strong></h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div id="card-content">
        <p class="text-justify">
        	 <h4 class="text-center"><strong>Nombre: Nombre del investigador</strong></h4>
      <h4 class="text-center"><strong>Correo: correo@domino.com</strong></h4>
        </p>
      </div>
      </div>
      <div class="modal-footer">
...
<header>
            ...
            <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <!-- <li class="dropdown" id="barra">
                                ...
                                <input id="buscar_investigador" class="form-control mr-sm-2" type="search" placeholder="Búsqueda" aria-label="Search">
                ...
                <br />
                <h2 align="center">Sistema de Reportes</h2>
                <br />                                    
            </div>
</header>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card-deck" id="reportes_cards">
            </div>        
	    </div> <!--end row-->
    </div><!--  end container -->
</body>
