                        ...
                        <form name="formulario" id="formulario" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <input type="hidden" name="lengua" id="lengua">
                                    <label>lengua</label>
                                    <input type="text" class="form-control" name="nombrelengua" id="nombrelengua" maxlength="60" placeholder="">

                                </div>

                                <div class="form-group col-md-4">
                                    <label>Grado Dominio </label>
                                    <input type="text" class="form-control" name="grado" id="grado" maxlength="60" placeholder="">
                                    
                                </div>
                                <div class="form-group col-md-4">
                                    <label>nivel Conversacion </label>
...
<script type="text/javascript" src="scripts/lenguas.js"></script>
<?php
ob_end_flush();
require 'footer.php';
?>